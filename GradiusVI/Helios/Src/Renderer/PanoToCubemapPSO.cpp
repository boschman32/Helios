...
// Compiled shader
#include "../Shaders/Headers/PanoToCubemap_cs.h"
...
PanoToCubemapPSO::PanoToCubemapPSO()
{
    ...
    m_DefaultUAV = DX12Renderer::GetInstance().AllocateDescriptors(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 5);
    /*UINT descriptorHandleIncrementSize = DX12Renderer::GetInstance().GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);*/
